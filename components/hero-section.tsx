                    ...
                    <div className="relative pt-24 md:pt-36">
                        ...
                        <div className="mx-auto max-w-7xl px-6">
                            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                                <AnimatedGroup variants={transitionVariants}>
                                    <Link
                                        href="/roadmap"
                                        className="hover:bg-white/10 bg-white/5 group mx-auto flex w-fit items-center gap-4 rounded-full border border-white/20 p-1 pl-4 backdrop-blur-sm transition-colors duration-300">
                                        <span className="text-white text-sm">✨ Beta Launch Q4 2025</span>
                                ...
                                <TextEffect
                                    ...
                                    All-in-One Platform for College Management
                                </TextEffect>
                                <TextEffect
                                    per="line"
                                    preset="fade-in-blur"
                                    ...
                                    Streamline attendance, marksheets, sessions, and more—tailor-made for affiliated colleges and deemed universities.
                                </TextEffect>
                        ...
                        <AnimatedGroup
                            ...
                            <div className="mask-b-from-55% relative -mr-56 mt-8 overflow-hidden px-2 sm:mr-0 sm:mt-12 md:mt-20">
                                <div className="relative mx-auto max-w-6xl overflow-hidden rounded-2xl border border-white/20 bg-white/5 backdrop-blur-md p-4">
                                    {/* Dashboard Preview Placeholder */}
                                    <div className="aspect-[15/8] relative rounded-2xl bg-gradient-to-br from-indigo-500/20 to-blue-500/20 backdrop-blur-sm flex items-center justify-center border border-white/10">
                                        <div className="text-center p-8">
                                            ...
                                            <p className="text-white/60">Real-time analytics for college management</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="mx-auto mt-12 grid max-w-4xl grid-cols-2 gap-8 sm:grid-cols-3 md:grid-cols-4">
                            <div className="flex items-center justify-center">
                                <div className="text-center">
                                    ...
                                    <p className="text-sm text-white/60">Colleges Ready</p>
                                </div>
                            </div>
                            <div className="flex items-center justify-center">
                                <div className="text-center">
                                    <p className="text-3xl font-bold text-indigo-400">10hrs</p>
                                    <p className="text-sm text-white/60">Time Saved/Week</p>
                                </div>
                            </div>
                            <div className="flex items-center justify-center">
                                <div className="text-center">
